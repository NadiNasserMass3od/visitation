...
class InactiveVisitorsScreen extends StatefulWidget {
  ...
  @override
  InactiveVisitorsScreenState createState() => InactiveVisitorsScreenState();
}

class InactiveVisitorsScreenState extends State<InactiveVisitorsScreen> {
  ...
  void _markConfessed(int id, String name) {
    showDialog(
      context: context,
          ...
          actions: [
            ...
            TextButton(
              ...
              onPressed: () {
                ...
                setState(() {
                  _inactiveVisitors
                      .removeWhere((confessor) => confessor.id == id);
                  _filteredVisitors
                      .removeWhere((confessor) => confessor.id == id);
                });
              },
