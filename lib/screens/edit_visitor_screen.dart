...
class EditVisitorScreen extends StatefulWidget {
  ...
  @override
  EditVisitorScreenState createState() => EditVisitorScreenState();
}

class EditVisitorScreenState extends State<EditVisitorScreen> {
  ...
  void initState() {
    ...
    _fatherName = widget.visitor.fatherName;
    _responsiblePriest = widget.visitor.responsiblePriest;
    _category = widget.visitor.category;
    _region = widget.visitor.region;
